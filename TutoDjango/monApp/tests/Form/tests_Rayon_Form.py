...
class RayonFormTest(TestCase):
    ...
    def test_form_valid_data_too_long(self):
        ...
        'RayonPourTestRayonPourTestRayonPourTestRayonPourTestRayonPourTestRayonPourTestRayonPourTestRayonPourTestRayonPourTestRayonPourTestRayonPourTestRayonPourTestRayonPourTestRayonPourTestRayonPourTestRayonPourTestRayonPourTestRayonPourTest'})
